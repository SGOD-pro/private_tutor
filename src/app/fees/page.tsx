...
function Fees() {
	...
	//TODO: allocate fees if the fees is 0
	return (
		<>
				...
				<Popover show={show2} setShow={setShow2}>
					<div className=" mt-2">
						...
						<section className="flex justify-between mt-2">
							<h2 className="text-xl">Souvik karmakar</h2>
							<div className="card flex justify-content-center">
								<button className="bg-teal-500 text-lg rounded-md px-3 py-1 flex items-center gap-1">
